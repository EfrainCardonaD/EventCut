  ...
  >
    ...
    >
      ...
      >
        <div
          v-if="modelValue && event"
          class="relative flex max-h-[100dvh] w-full flex-col overflow-hidden border-0 border-slate-200 bg-white/75 shadow-2xl backdrop-blur-md dark:border-slate-800 dark:bg-slate-900/75 sm:max-h-[90vh] sm:max-w-4xl sm:rounded-3xl sm:border"
        >
          <header
          ...
          <div class="flex-1 overflow-y-auto overscroll-contain">
            <div class="flex h-full flex-col p-2 md:flex-row">
              <div class="relative w-full shrink-0 md:w-5/12">
                <img :src="coverImageUrl" :alt="event.title" class="w-full object-cover md:absolute md:inset-0" />
                <div class="absolute left-0 top-0 bg-gradient-to-b from-slate-900/80 via-slate-900/20 to-transparent md:bg-gradient-to-tr"></div>
              ...
              <div class="flex flex-1 flex-col space-y-6 p-4 sm:space-y-8 sm:p-6">
