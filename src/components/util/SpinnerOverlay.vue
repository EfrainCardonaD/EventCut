<template>
  <div v-if="show">
    <div v-if="mode === 'overlay'" class="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
      <div class="flex items-center gap-3 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 px-4 py-3 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700">
