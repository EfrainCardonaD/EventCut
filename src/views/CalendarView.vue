...
<template>
  <div class="min-h-screen overflow-y-auto bg-slate-50 px-4 pb-24 pt-24 text-slate-900 transition-colors duration-300 dark:bg-[#0f1418] dark:text-[#dfe3e8] md:h-[calc(100vh-5rem)] md:overflow-hidden md:px-8 md:pb-6 md:pt-20">
    ...
    <div class="mx-auto grid h-full w-full max-w-7xl grid-rows-[auto_minmax(0,1fr)] gap-4 md:gap-6">
      <header class="snap-start rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-[#171c20] sm:p-6">
        ...
        <div class="mt-4 flex flex-wrap gap-2">
          <span class="rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold text-slate-600 dark:bg-[#1f262c] dark:text-slate-300">
          ...
          <span class="rounded-full bg-white px-3 py-1 text-xs font-semibold text-slate-600 ring-1 ring-slate-200 dark:bg-[#1b2024] dark:text-slate-300 dark:ring-slate-700">
      ...
      <div class="grid min-h-0 snap-y snap-proximity grid-cols-1 auto-rows-max gap-4 overflow-y-auto pb-2 md:gap-6 md:snap-none lg:grid-cols-[minmax(0,1fr)_minmax(21rem,24rem)] lg:auto-rows-fr lg:overflow-hidden lg:pb-0">
        <section class="snap-start rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-[#171c20] sm:p-5 lg:min-h-0">
        ...
        <section class="grid min-h-0 snap-start gap-4 lg:grid-rows-[minmax(0,1fr)_auto]">
          <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-[#171c20] sm:p-5 lg:min-h-0">
          ...
          <div class="hidden rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-[#171c20] lg:block">
    ...
    >
      <RouterLink to="/app" class="flex flex-col items-center justify-center p-2 text-slate-500 transition-colors hover:text-sky-600 dark:text-slate-400 dark:hover:text-[#88ceff]">
      ...
      <RouterLink to="/app/calendario" class="flex flex-col items-center justify-center p-2 text-sky-600 dark:text-[#88ceff]">
        <span class="mb-1 rounded-full bg-sky-100 px-4 py-1 dark:bg-[#009bdb]/20">
